...
if( isset( $_POST['btnSubmit'] ) )
{
    ...
    // Prepared Statement
    $stmt = $mysqli->prepare("INSERT INTO `data_pasien` (`Nama_Pasien`, `Jenis_Kelamin`, `Agama`, `Alamat`, `Pekerjaan`, `Keterangan`, `Tindakan`) VALUE(?, ?, ?, ?, ?, ?, ?)");
    ...
    if( $result ) {
        ...
        $alert_message = "Terdapat Kesalahan Saat Menambahkan Data. Coba Lagi.";
    }
...
<head>
    ...
    <title>PHP CRUD Using MYSQL Prepared Statement - Tambahkan Data Pasien Baru</title>
</head>
<body>
    <div class="container">
        <div class="row">
